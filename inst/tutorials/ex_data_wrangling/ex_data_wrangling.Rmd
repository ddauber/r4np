...
```{r clean-col-names-janitor-hint-2, eval=FALSE}
...
```{r rename-cols-hint-1, eval=FALSE}
...
```{r rename-cols-hint-2, eval=FALSE}
...
```{r rename-cols-hint-3, eval=FALSE}
...
```{r rename-cols-hint-4, eval=FALSE}
...
```{r change-data-types, exercise=TRUE, exercise.lines = 10, exercise.eval=FALSE}
# Inspect dataset
...
```{r change-data-types-hint-2, eval=FALSE}
glimpse(halloween)
...
```{r recoding-gender-country-hint-1, eval=FALSE}
...
```{r recoding-gender-country-hint-3, eval=FALSE}
...
```{r recoding-gender-country-hint-4, eval=FALSE}
...
```{r internal-consistency-happy-hint, eval=FALSE}
...
```{r internal-consistency-stress-hint-1, eval=FALSE}
...
```{r compute-latent-variables-hint-1, eval=FALSE}
...
```{r compute-latent-variables-hint-2, eval=FALSE}
